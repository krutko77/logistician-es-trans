...
//От кого письмо
$mail->setFrom('drivers-lending77@es-trans.ru', 'Лендинг по поиску логиста');
//Кому отправить
$mail->addAddress('kpv@es-trans.pro'); // Указать нужный E-mail 
//Тема письма
$mail->Subject = 'Привет! Это запрос с лендинга по поиску логиста.';

//Тело письма
$body = '<h1>Меня интересует работа логиста в ООО "ЕС Транс"</h1>';
